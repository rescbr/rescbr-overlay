...
SRC_URI="
	x86? ( https://julialang-s3.julialang.org/bin/linux/x86/1.3/${MY_P}-linux-i686.tar.gz )
	amd64? ( https://julialang-s3.julialang.org/bin/linux/x64/1.3/${MY_P}-linux-x86_64.tar.gz )
	amd64-fbsd? ( https://julialang-s3.julialang.org/bin/freebsd/x64/1.3/${MY_P}-freebsd-x86_64.tar.gz )
"
